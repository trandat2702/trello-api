...
import { EMAIL_RULE, EMAIL_RULE_MESSAGE, PASSWORD_RULE_MESSAGE, PASSWORD_RULE } from '~/utils/validators'
...
const update = async (req, res, next) => {
  ...
  try {
    //Lưu ý đối với trường hợp update, cho phép Unknown để k cần đầy một số field lên
